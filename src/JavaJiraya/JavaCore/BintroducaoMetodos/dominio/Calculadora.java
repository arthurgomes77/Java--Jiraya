...
public class Calculadora {
    ...
    public void somaVarArgs(int... numeros) { // Transforma oque é adicionado no campo de entrada, utiliza o VarArgs apenas como ultima entrada, se tiver mais dependencias é preciso vir antes
        int soma = 0;
        for (int num : numeros) {
            soma += num;
        }
